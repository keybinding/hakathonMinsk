...
public class ViewSwitcher2 : MonoBehaviour {
    ...
    void DeleteSecondaryPanels()
    {
        ...
        l_stack.Push(parentPanel.rightPanel);
        while (l_stack.Count > 0)
        {
            ...
            if (l_curTr.childCount > 0)
            {
                ...
                {
                    if (i_primaryPanels.Contains(l_tr.gameObject)) l_tr.SetParent(parentPanel.rightPanel.transform, false);
