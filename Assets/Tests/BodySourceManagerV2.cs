...
public class BodySourceManagerV2 : MonoBehaviour {
    ...
    [System.Serializable]
    public class FrameArrived : UnityEvent<Body[]> { }
...
public interface BodySourceManagerListener
{
    void FrameArrived(Body[] a_bodies);
}
